...
import { Home, LayoutGrid, LineChart, MoreHorizontal, Plus } from 'lucide-react'
    ...
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-line bg-white/95 pb-[env(safe-area-inset-bottom)] backdrop-blur">
      <div className="mx-auto grid max-w-lg grid-cols-5 items-end px-1 pt-1">
        ...
        <div className="flex justify-center">
          <button
            type="button"
            aria-label="Captura rápida, disponible pronto"
            onClick={() => showToast('La captura rápida llega en la siguiente fase')}
